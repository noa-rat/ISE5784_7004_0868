...
public class LightsTests {
     ...
     */
    @Test
    public void multiLightSphereTest() {
        scene1.geometries = new Geometries(sphere);
        scene1.lights = new LinkedList<LightSource>();
        scene1.lights.add(new DirectionalLight(new Color(500, 800, 0), new Vector(-2, 1, 0.5)));
        scene1.lights.add(new PointLight(new Color(700, 50, 800), new Vector(100, 100, 25))
                .setkL(0.001).setkQ(0.0001));
        scene1.lights.add(new SpotLight(sphereLightColor, sphereLightPosition, sphereLightDirection)
                .setkL(0.001).setkQ(0.0001));
     ...
     */
    @Test
    public void multiTriangleTest() {
        scene2.geometries = new Geometries(triangle1,triangle2);
        scene2.lights = new LinkedList<LightSource>();
        scene2.lights.add(new DirectionalLight(new Color(100, 150, 800), new Vector(-2,1,0.5)));
        scene2.lights.add(new PointLight(new Color(800, 50, 400), new Vector(-50, -100, -25))
                .setkL(0.0005).setkQ(0.00005));
        scene2.lights.add(new SpotLight(trianglesLightColor, trianglesLightPosition, trianglesLightDirection)
                .setkL(0.001).setkQ(0.0001));

        camera2.setImageWriter(new ImageWriter("multiTriangle", 500, 500)) //
                .build()
                .renderImage()
                .writeToImage();
