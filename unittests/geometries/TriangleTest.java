...
class TriangleTest {
    ...
    void testfindIntersections() {
        ...
        assertNull(triangle.findIntersections(new Ray(new Point(0.5, 4, -1), new Vector(0, 0, 1))),
                "Error: there are not intersection points");
        ...
        assertNull(triangle.findIntersections(new Ray(new Point(4, 0, -1), new Vector(0, 0, 1))),
                "Error: there are not intersection points");
    }
}